...
Installation, Usage and Configuration is explained in VR Payment's [online documentation](https://docs.plugin-documentation.vr-payment.de/vr-payment/salesforce-commerce-cloud/1.0.19/docs/en/documentation.html).
