...
server.get('VRPaymentConfirm', consentTracking.consent, server.middleware.https, csrfProtection.generateToken, function (req, res, next) {
...
server.get('VRPaymentFail', consentTracking.consent, server.middleware.https, csrfProtection.generateToken, function (req, res, next) {
    res.render('/error', {
    ...
    req.session.raw.custom.VRPaymentTransactionId = null;
    return next();
});
